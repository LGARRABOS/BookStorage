...
**Mise à jour sans menu :** définir `BSCTL_UPDATE_TAG=v5.7.0` puis `sudo -E bsctl update`. Le dépôt local est aligné sur la release ou sur `origin/<branche>` (les modifs locales sur fichiers suivis sont écrasées).
