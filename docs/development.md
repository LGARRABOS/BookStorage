...
- `GET /api/admin/prometheus/summary` (admin, desktop web) returns a small JSON snapshot from the local Prometheus HTTP API (`BOOKSTORAGE_PROMETHEUS_QUERY_URL`, loopback-only) for the Monitoring page.
