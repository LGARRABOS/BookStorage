...
cmd_help() {
    ...
    printf "    ${BLUE}BSCTL_UPDATE_TAG=v4.0.1 sudo -E bsctl update${NC}  Non-interactive tag\n"
    printf "    ${BLUE}sudo bsctl update main${NC}         Sync to latest origin/main\n"
    printf "    ${BLUE}sudo bsctl update my-branch${NC}  From origin/my-branch\n"
